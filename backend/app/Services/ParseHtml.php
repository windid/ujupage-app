...
class ParseHtml {
    ...
    protected static function parseElement($element_id, $element){
        ...
        if (isset($element['fixed']) && $element['fixed']) {
            ...
            self::$page['style']['pc']['element-'.$element_id]['zIndex'] += 50000;
            self::$page['style']['mobile']['element-'.$element_id]['zIndex'] += 50000;
    ...
    protected static function parseElementForm ($element_id, $element) {
        ...
        self::$page['style']['common']['element-'.$element_id." input"] = self::parseStyles([
    ...
    protected static function parseElementIcon ($element_id, $element) {
        ...
        self::$page['style']['pc']['element-'.$element_id.' span']['font-size'] = $element['style']['pc']['width'];
        self::$page['style']['mobile']['element-'.$element_id.' span']['font-size'] = $element['style']['mobile']['width'];
