...
export const selectionAlignLeft = selector.alignLeft.bind(selector)
export const selectionAlignCenter = selector.alignCenter.bind(selector)
export const selectionAlignRight = selector.alignRight.bind(selector)
export const selectedElementsMove = selector.move.bind(selector)
