  ...
  <div class="fixed-header editor-header">
    ...
    <div class="btn-toolbar fr">
      ...
      <div class="btn-group">
        ...
        <div class="btn btn-default" :class="{ disabled: saveStatus }" @click="saveVariation()">保存 
          <span :class="saveStatus ? 'glyphicon glyphicon-floppy-saved' : 'glyphicon glyphicon-floppy-disk'"></span>
        </div>
