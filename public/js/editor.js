	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      buttonGroup: 'main',
	      editing: false,
	      textElement: (0, _lodash.merge)({}, this.element),
	      changed: false
	    };
	  },
